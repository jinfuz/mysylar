...
/**
 * @brief TCP服务器封装，TcpServer类采用了Template Pattern设计模式，它的HandleClient
 * 是交由继承类来实现的。使用TcpServer时，必须从TcpServer派生一个新类，并重新实现子类
 * 的handleClient操作，这点可以参考test_tcp_server.cc。
 */
